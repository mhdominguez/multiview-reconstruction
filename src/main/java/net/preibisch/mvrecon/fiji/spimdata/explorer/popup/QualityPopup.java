...
import net.preibisch.mvrecon.fiji.plugin.Image_Quality;
import net.preibisch.mvrecon.fiji.spimdata.SpimData2;
import net.preibisch.mvrecon.fiji.spimdata.explorer.ExplorerWindow;

import mpicbg.spim.data.sequence.ViewId;

public class QualityPopup extends JMenuItem implements ExplorerWindowSetable
{
	...
	public QualityPopup()
	{
		super( "Image Quality Estimation (FRC) ..." );
